     ...
     <img class="scrollButtons left" src="images/leftarrow.png">
  	  <div style="overflow: hidden;" class="scroll">
          ...
          <div class="panel" id="panel_1">
						<div class="inside">
							<img src="images/barcellzamp.jpg" alt="picture"/>
							<h2>Cadastro de Clientes</h2>
							<p>Clique para ver... <a href="cadastrocliente.php" target="_blank">Cadastrar</a></p>
						</div>
					</div>
          ...
          <div class="panel" id="panel_2">
						<div class="inside">
							<img src="images/barcellzamp.jpg" alt="picture" />
							<h2>Checklist Visitas</h2>
							<p>Clique para cadastrar visita <a href="./visitas/" target="_blank">Cadastrar!</a></p>
						</div>
					</div>
          ...
          <div class="panel" id="panel_3">
						<div class="inside">
							<img src="images/barcellzamp.jpg" alt="picture" />
							<h2>Relatórios</h2>
							<p>Clique para ver relatórios... <a href="./relatorios/" target="_blank">Ver Relatórios!</a></p>
						</div>
					</div>
					<!--
...
<section id="footer-area">
	<section id="footer-outer-block">
			...
			<aside class="footer-segment last">
					<h4>&nbsp;</h4>
						<p>&copy; 2018 <a href="#">Marcos Paulo Riquetta</a></p>
